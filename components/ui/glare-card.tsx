...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="relative isolate [aspect-ratio:10/9] w-[330px] transition-transform delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] will-change-transform [contain:layout_style] [perspective:600px]"
      ref={refElement}
      onPointerMove={(event) => {
