...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border-subtle bg-background-start/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-foreground-muted text-sm leading-relaxed max-w-md mb-6">
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-card-bg border border-border-subtle flex items-center justify-center text-foreground-muted hover:text-accent hover:border-accent/30 transition-all"
